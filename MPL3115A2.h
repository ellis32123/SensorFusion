...
#define NUM_OF_OUTPUT_BYTES 3
#define MAX_WAIT_MICROS 512000
...
public:
  ...
  float readRawBits();
    float altitude = 0;
    void setOversample(byte sampleRate);
  //Public Variables
    protected:
...
private:
 ...
 void strobeOneShot();
  ...
  unsigned long current_millis = 0, previous_millis = 0, current_micros = 0;
